/*
  ...
  - The values [FINALIZED] on the enum `Status` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."Status_new" AS ENUM ('IN_PROGRESS', 'PENDING', 'COMPLETED');
...
ALTER TABLE "public"."Project" ALTER COLUMN "status" SET DEFAULT 'COMPLETED';
COMMIT;
